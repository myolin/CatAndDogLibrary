...
@MainActor
class DogIdentifierViewModel: ObservableObject {
    ...
    let dogPredictionEndpoint = "https://detect.roboflow.com/dog-seeker-rppqw/4?api_key="
    ...
    func analyze(uiImage: UIImage) async {
        ...
        var request = URLRequest(url: URL(string: "\(dogPredictionEndpoint)\(roboflowApiKey)")!, timeoutInterval: Double.infinity)
