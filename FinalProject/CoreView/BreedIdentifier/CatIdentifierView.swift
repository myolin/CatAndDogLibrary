...
struct CatIdentifierView: View {
    @StateObject private var viewModel = CatIdentifierViewModel()
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                ...
                Image(uiImage: (uiImage ?? UIImage(named: "Cat")!))
                    .resizable()
                    .scaledToFill()
                ...
                HStack {
                    Image(systemName: "exclamationmark.triangle")
                        ...
                        .fontWeight(.semibold)
                    Text("Please only upload Cat photo!")
                }
                HStack(spacing: 20) {
                    Button {
                        Task {
